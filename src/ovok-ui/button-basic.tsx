...
export default function ButtonBasic({
  ...
  return (
    <Pressable
      className="my-3 flex-row rounded-lg border border-[rgb(215,221,234)] bg-[white]"
      style={{ height: subtitle ? 62 : 60 }}
    >
      <View
        className={
          iconNameLeft === 'hiv-monitoring'
            ...
            : 'm-3 h-[44px] w-[44px] items-center justify-center bg-[red]'
        }
      >
